...
const EducationItem = ({ education }) => {
    return ( <
        ...
        li >
        <
        FaUniversity className = "edu-icon" / > { education.university } <
        /li> <
        li >
        <
        FaCalendarAlt className = "edu-icon" / > { education.year } <
        /li> <
        li >
        <
        FaPercentage className = "edu-icon" / > { education.percentage } <
        /li> <
        /ul> <
        /div> <
        /div>
